'use strict'
// set of functions to carry out unique tasks.

const streakSort = ((actor) =>{
  return formatResult(streakOrder(dateSort(actor)));
})

// return the time format for a given date
const getTime = (date) => new Date(date).getTime();

// sorts actor array by date
const dateSort = ((arr) => {
...
// removes 'streak' and 'created_at' from resulting array objects
...
// orders actor array by streak..
const streakOrder = ((arr) => {
const d = arr;
const actorEvents = [];
let count = 0;
